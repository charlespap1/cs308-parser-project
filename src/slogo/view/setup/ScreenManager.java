...
public class ScreenManager {
    ...
    public StringProperty getLanguageChoice() {
        return myLanguageSelector.getLanguageChoiceProperty();
    }
     ...
     * @return
     */
    public int getPenDown(List<Double> params) {
        return myGraphicalMover.getPenUp() ? 0 : 1;
    }

    public int getPenColor(List<Double> params) {
        return myDisplayCustomizer.getPenIndex();
    }

    public int getShape(List<Double> params) {
        return myDisplayCustomizer.getImageIndex();
    }
