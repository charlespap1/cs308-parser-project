...
public class CommonCommands {
    private static final String COMMON_COMMAND_TITLE = "Common Commands";
    private static final String BACK_BUTTON_KEY = "CommonCommandBackButton";
    private static final String HYPERLINK_TEXT_KEY = "HyperlinkText";
    private static final String MATH_OPS_KEY = "MathOperationsText";
    private static final String BOOLEAN_OPS_KEY = "BooleanOperationsText";
    private static final String QUERIES_KEY = "TurtleQueriesText";
    private static final String COMMANDS_KEY = "TurtleCommandsText";

    private static final double BUTTON_PADDING = 10;
    private static final double TOP_PADDING = 30 + BUTTON_PADDING;
    private static final double HYPERLINK_PADDING = 150;
    private static final String MAIN_STYLESHEET = "main.css";
    private static final String LINK_TO_ALL_COMMANDS = "https://www2.cs.duke.edu/courses/spring20/compsci308/assign/03_parser/commands.php";
    ...
    private Scene setupCommandScene() {
        ...
        for (int i = 0; i < KEYS.size(); i++) {
            ...
            panel.setTitleProperty(Collections.singletonList(myLanguageHelper.getStringProperty(COMMANDS_KEY)));
    ...
    private void setHyperlink(Group root) {
        ...
        myLink.setOnAction(e -> {
            try {
                java.awt.Desktop.getDesktop().browse(java.net.URI.create(LINK_TO_ALL_COMMANDS));
