...
public class CommandPanel implements StaticViewElement {
    private static final int HOLDER_PADDING = 10;
    private static final int SCROLLER_HEIGHT = SetupScreen.WIDTH - 400;
    private static final int NUM_PANELS = 4;
    private static final String TAB = "     ";
    private static final String RESOURCES = "resources";
    private static final String RESOURCE_PACKAGE = RESOURCES + ".commands.";
